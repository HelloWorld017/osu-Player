...
var BGM_URL = "/load/";
var LYRIC_URL = "/lyric/";
var IMG_URL = "//b.ppy.sh/thumb/{0}l.jpg";

var MUSIC_BASE = "https://bgm.khinenw.tk/";
var EMBED_URL = "//bgm.khinenw.tk/embed/?";
var EMBED_TEMPLATE = '<iframe src="{%src}" width="310" height="26" style="border: none"></iframe>';
var DOWNLOAD_URL = "https://bloodcat.com/osu/s/";
...
$(document).ready(function(){
	...
	progress.on('slide', function(){
		console.log(progress.slider('getValue'));
